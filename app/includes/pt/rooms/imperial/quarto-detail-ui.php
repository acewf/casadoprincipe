...
<div class="page-content spec-room">
    <section class="content inside-room room-detail">
        ...
        <article class="show-room-description">
            <div class="left-block">
                ...
                <a class="big-size"><h4>Sobre O Rei D. Pedro V</h4> <div class="icon icon-inline icon-angle-right"></div></a>
            </div>
        </article>
        <article class="show-rooms">
            ...
            <div class="rooms-types">
                <ul class="choose-rooms">
                    <li class="actived"><a data-pageid="page1" href="<?php echo $basePath.$lang; ?>suites-rooms/royal">SUITES REAIS</a></li>
    ...
    <section class="app-history inside-room inside-detail">
        <div class="back-detail-room"><div class="icon icon-inline icon-angle-left"></div> VOLTAR PARA O SUITE REI D. PEDRO V</div>
