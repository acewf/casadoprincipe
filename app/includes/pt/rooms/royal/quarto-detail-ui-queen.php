...
<div class="page-content spec-room">
    <section class="content inside-room room-detail">
        ...
        <article class="show-room-description">
            <div class="left-block">
                ...
                <a class="big-size"><h4>Sobre a Rainha D. Estefânia</h4> <div class="icon icon-inline icon-angle-right"></div></a>
            </div>
        </article>
    ...
    <section class="app-history inside-room inside-detail">
        <div class="back-detail-room"><div class="icon icon-inline icon-angle-left"></div> VOLTAR PARA O SUITE RAINHA D. ESTEFÂNIA</div>
