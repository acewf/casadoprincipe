...
<div class="page-content spec-room">
    <section class="content inside-room room-detail">
        ...
        <article class="show-room-description">
            <div class="left-block">
                ...
                <a class="big-size"><h4>Sobre a ligação do Príncipe Real à cidade de Lisboa<div class="icon icon-arrow-right"></div></h4></a>
            </div>
        </article>
    ...
    <section class="app-history inside-room inside-detail">
        <div class="back-detail-room">VOLTAR PARA O QUARTO DA CIDADE DE LISBOA</div>
